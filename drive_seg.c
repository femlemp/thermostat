...
static const uint8_t adr_r = 0b01000001;
static const uint8_t adr_w = 0b01000000;
/* SEG:TOD-5263BMB-N
...
void DIGSEG_init(void){
	I2C_Init();
}
void DIGSEG_print(uint8_t* symb){
	uint8_t temp[2], dig1;
	dig1 = 0x0F&(*symb/10);
	if(dig1>=10){
		if(*symb==104){//error
	...
	I2C_WriteData(adr_w,sizeof(temp),temp);
	_delay_ms(50);
}
